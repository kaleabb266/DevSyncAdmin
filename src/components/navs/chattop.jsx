...
import RateUser from '../main/Rating'; // Adjust the path as necessary
...
const Chattop = ({ chat, username, activeChatId, user }) => {
    ...
    const [showRateModal, setShowRateModal] = useState(false); // State to handle rating modal
                            ...
                            <div className="flex items-center ml-4 md:ml-6">
                                ...
                                <dialog open={showRateModal} className="modal" onClose={() => setShowRateModal(false)}>
                                    <div className="modal-box">
                                        ...
                                        <RateUser username={otherUser.username} />
                                        <div className="modal-action">
